...
public class ListViewRemoteViewsFactory implements RemoteViewsService.RemoteViewsFactory {
    ...
    public RemoteViews getViewAt(int i) {
        ...
        if (dayNames[i].equals(dayNum)) {
            rv.setTextViewText(R.id.widget_listitem_text1, Html.fromHtml(String.format("<b>%s</b>", text2)));
            rv.setTextViewText(R.id.widget_listitem_text2, Html.fromHtml(String.format("<b>%s</b>", text3)));
            rv.setTextViewText(R.id.widget_listitem_text3, Html.fromHtml(String.format("<i><b>%s</i></b>", text1)));
            ...
            rv.setTextViewText(R.id.widget_listitem_text1, text2);
            rv.setTextViewText(R.id.widget_listitem_text2, text3);
            rv.setTextViewText(R.id.widget_listitem_text3, Html.fromHtml(String.format("<i>%s</i>", text1)));
